...
namespace LR1
{
    public class Text
    {
        ...
        public static  bool IsWordBegWithConsLetter(Word word)
        {
        ...
        public void Output(StreamWriter writer, bool isPresenseOfLineFeed)
        {
            writer.WriteLine(ToString(isPresenseOfLineFeed));
        }
        ...
        public void PrintWordsInInterrogativeSentWithoutRepetitions(StreamWriter writer, int len)
        {
        ...
        public void WordsDeleteBegWithAConsonant(int len)
        {
            for (int i = 0; i < Length; i++)
            {
                for (int j = 0; j < sentences[i].Length; j++)
        ...
        public void Concordance(StreamWriter writer, int numOfLines)
        {
            int currentPage = 1;
            string temp_str = "";
            var dictionary = new SortedDictionary<string, MyValue>();//MySortedDictionary();
            var temp = new MyValue();
